  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="pt-14 px-[10px] pb-[10px] flex flex-col gap-2 w-full justify-between h-full">
          ...
          <button
            ...
            className="bg-black disabled:bg-gray-400 hover:bg-gray-600 text-white shadow-md font-bold py-2 px-4 rounded-xl active:translate-y-1"
          >
